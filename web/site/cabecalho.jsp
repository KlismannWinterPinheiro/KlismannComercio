	...
	<!--header-->
		<div class="header">
			...
			<div class="container">
				<div class="top-right">
				<ul>
					<li class="text"><a href="login.jsp">Entrar</a></li>
...
<div class="content white">
	<nav class="navbar navbar-default" role="navigation">
	    <div class="navbar-header">
	        ...
	        <h1 class="navbar-brand"><a  href="index.jsp">Killersmann Music</a></h1>
	    </div>
	    <!--/.navbar-header-->
	...
	<!--/.navbar-->
			   ...
			   <div class="search-box">
					<div id="sb-search" class="sb-search">
						<form>
							<input class="sb-search-input" placeholder="O que procura?" type="search" name="search" id="search">
